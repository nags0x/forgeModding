package net.nags.tutorialmod.datagen;

import net.nags.tutorialmod.TutorialMod;
//import net.nags.tutorialmod.block.ModBlocks;
...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(ModItems.DINO_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
    }
